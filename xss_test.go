...
func newServer(defender *Defender) *gin.Engine {
...
func TestKeepsValuesStripsHtmlOnPut(t *testing.T) {
	...
	s := newServer(DefaultDefender(SetSkipFields("password")))
...
func TestUGCPolityAllowSomeHTMLOnPost(t *testing.T) {
	...
	s := newServer(DefaultDefender(SetPolicy(bluemonday.UGCPolicy())))
